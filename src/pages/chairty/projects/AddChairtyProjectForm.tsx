...
import { addCharityProject } from '../../../services/charityProjectService';
...
const DURATIONS = ['مؤقت', 'دائم', 'تطوعي', 'فردي'];
...
const AddProjectForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await addCharityProject(
        {
          ...
          // duration_type غير مُستخدم في الخدمة، لذا لا نُرسله
        },
        file
      );
